...
ActiveRecord::Schema.define(version: 20_190_528_142_203) do
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.index %w[phrase_id created_at], name: 'index_comments_on_phrase_id_and_created_at'
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[phrase_id created_at], name: 'index_likes_on_phrase_id_and_created_at'
    t.index ['phrase_id'], name: 'index_likes_on_phrase_id'
    t.index %w[user_id created_at], name: 'index_likes_on_user_id_and_created_at'
  ...
  create_table 'phrases', force: :cascade do |t|
    ...
    t.string 'url_title'
    t.string 'author'
    t.index %w[user_id created_at], name: 'index_phrases_on_user_id_and_created_at'
