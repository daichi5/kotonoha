...
ActiveRecord::Schema.define(version: 2019_05_28_142203) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["phrase_id", "created_at"], name: "index_comments_on_phrase_id_and_created_at"
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["phrase_id", "created_at"], name: "index_likes_on_phrase_id_and_created_at"
